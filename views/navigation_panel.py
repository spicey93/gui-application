...
class NavigationPanel(QFrame):
    ...
    def _create_widgets(self):
        ...
        # Customers menu item
        self.customers_button = QPushButton("Customers (F3)")
        self.customers_button.setObjectName("navButton")
        self.customers_button.setMinimumHeight(30)
        self.customers_button.clicked.connect(self._handle_customers)
        nav_layout.addWidget(self.customers_button)
        
        # Products menu item
        self.products_button = QPushButton("Products (F4)")
    ...
    def _setup_keyboard_navigation(self):
        ...
        self.customers_button.setFocusPolicy(Qt.FocusPolicy.StrongFocus)
    ...
    def _handle_customers(self):
        ...
        if self.current_view != "customers":
