...
class ReportsView(BaseTabbedView):
    """Reports view GUI for financial statements."""
    ...
    def __init__(self):
        ...
        super().__init__(title="Reports", current_view="reports")
    ...
    def _create_widgets(self):
        ...
        self.add_tab(vat_widget, "VAT Return (Ctrl+1)", "Ctrl+1")
        ...
        self.add_tab(pl_widget, "Profit & Loss (Ctrl+2)", "Ctrl+2")
        ...
        self.add_tab(tb_widget, "Trial Balance (Ctrl+3)", "Ctrl+3")
        ...
        self.add_tab(bs_widget, "Balance Sheet (Ctrl+4)", "Ctrl+4")
